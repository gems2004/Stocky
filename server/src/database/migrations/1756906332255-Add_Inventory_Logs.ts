...
export class AddInventoryLogs1756906332255 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "inventory_logs" ("id" SERIAL NOT NULL, "product_id" integer NOT NULL, "change_amount" integer NOT NULL, "reason" text, "user_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_06b444680ab11eb7c7d0ed6eced" PRIMARY KEY ("id"))`);
